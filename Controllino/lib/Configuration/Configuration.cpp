...
namespace Configuration {
    ...
    void setPLCTopicState() {
        Serial.print ("Introduce Topic para el PLC: ");   
        state = PLCTopicState;
    }
   ...
   void setRootTopicState() {
        Serial.print ("Introduce Topic raiz: ");   
    ...
    void setCommandTopicState() {
        Serial.print ("Introduce Topic para comandos: ");   
   ...
   void setStateTopicState() {
        Serial.print ("Introduce Topic para estado: ");   
   ...
   void setLogTopicState() {
        Serial.print ("Introduce Topic para log: ");   
        state = logTopicState;
   }  
   ...
   void setIPState() {
        Serial.print ("Introduce IP: (nnn.nnn.nnn.nnn)");   
        state = IPState;
   }  
   ...
   void setServerState() {
        Serial.print ("Introduce IP servidor: (nnn.nnn.nnn.nnn)");   
        state = serverState;
   }  
   ...
   void server_State(String readedString) {
    ...
    void setPortState() {
        Serial.print ("Introduce puerto servidor: ");   
        state = portState;
   } 
