 ...
 */
 ...
 /*
   Modifications for CONTROLLINO platform
   20.11.2015 - Added support for CONTROLLINO MEGA and CONTROLLINO MAXI
   23.01.2017 - Added support for CONTROLLINO MAXI Automation variant
 */
